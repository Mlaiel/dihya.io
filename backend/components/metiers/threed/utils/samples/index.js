// index.js – Exécution centralisée des samples JS pour tous les modules métier
...
console.log('Découverte des samples JS :');
allSamples.forEach(sample => {
  console.log('Chargement du sample :', sample);
  require(sample);
});
