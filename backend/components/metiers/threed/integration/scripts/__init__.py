"""
__init__.py – Initialisation ultra avancée du module scripts integration Threed
"""
import importlib
import pkgutil
import os
...
for finder, name, ispkg in pkgutil.iter_modules([package_dir]):
    if not name.startswith("_"):
        ...
        globals()[name] = module
        __all__.append(name)
# Import dynamique des modules script_
for file in os.listdir(os.path.dirname(__file__)):
    if file.startswith("script_") and file.endswith(".py"):
        module_name = file[:-3]
