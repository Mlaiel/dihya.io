// __init__.js – Initialisation avancée des tests d'intégration (racine)
/**
 * Import/export dynamique, auto-discovery, extension future pour tous les sous-dossiers de tests d'intégration Threed.
